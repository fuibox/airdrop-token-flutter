...
class _Web3TasksScreenState extends State<Web3TasksScreen> {
  ...
  void initState() {
    super.initState();
    taskStakeController.getUserStakeInfo();
  }
    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            Obx(() {
              final isStaked = taskStakeController.stakeInfo.value['isStaked'];
              return Container(
                width: 343.w,
                // height: 154.w,
            ...
            Obx(() {
              final isStaked =
                  taskStakeController.stakeInfo.value['isStaked'] ?? false;
              final stakeInfo = taskStakeController.stakeInfo.value;
              final endTime =
                  calculateRemainingTime(stakeInfo['expireTime'] ?? 0);
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: CustomCountdownTimer(
                                endTime: stakeInfo['expireTime'], // 传递结束时间
                        ...
                        InkWell(
                          onTap: () {
                            taskStakeController.postUserStakeRewardClaim();
                          },
                          child: Row(
                            children: [
                              Container(
